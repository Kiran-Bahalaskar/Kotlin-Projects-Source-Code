package com.adt.alphadev.firstprojectinkotlin.IntroSlider.Layout_Class
        ...
        if (position >= 0 && position <= indicatorCount) {
            ...
            for (index in 0 until indicatorCount) {
                ...
                if (index == selectedPosition) {
                    indicator.setBackgroundColor(R.drawable.indicator_selected)
                } else {
                    indicator.setBackgroundColor(R.drawable.indicator_unselected)
                }
            }
        }
    }
